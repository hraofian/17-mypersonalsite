    ...
    <div>
      ...
      <section className="home-services py-5" id="services">
        <div className="container py-lg-5 py-md-4 py-2">
          ...
          >
            <h5 className="small-title mb-2">Best Services</h5>
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-4 col-md-6 mt-4">
              <div className="box-wrap">
                ...
                <h4>
                  <a href="#url">Business Planning</a>
                </h4>
                <p>
                  Lorem ipsum dolor sit amet sed consectetur adipisicing elit.
                  doloret quas saepe autem, dolor set.
        ...
        <div className="container py-md-5 py-sm-4 py-2">
          <div className="row py-4">
            <div className="col-lg-7">
              ...
              <a href="contact.html" className="btn btn-style mt-md-5 mt-4">
                Contact Us
              </a>
            </div>
          </div>
